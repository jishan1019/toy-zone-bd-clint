...
const Gallary = () => {
  return (
    <section className=" mt-12 pl-6 pr-6 w-full">
      ...
      <div className="grid grid-cols-1 bg-white text-sm lg:grid-cols-3 lg:w-[85%] w-full mx-auto mt-8 gap-6">
        <div className="bg-[#F3F5F7] shadow-md p-2 rounded">
          ...
          <div className="h-6 w-full">
            <h1 className="font-semibold mt-2">Sports Gallary</h1>
          </div>
        </div>
        ...
        <div className="bg-[#F3F5F7] shadow-md p-2 rounded">
          ...
          <div className="h-6 w-full">
            <h1 className="font-semibold mt-2">Truck Gallary</h1>
          </div>
        </div>
        ...
        <div className="bg-[#F3F5F7] shadow-md p-2 rounded">
          ...
          <div className="h-6 w-full">
            <h1 className="font-semibold mt-2">Regular Car Gallary</h1>
          </div>
        </div>
        ...
        <div className="bg-[#F3F5F7] shadow-md p-2 rounded">
          ...
          <div className="h-6 w-full">
            <h1 className="font-semibold mt-2">Mini Fire Truck Gallary</h1>
          </div>
        </div>
        ...
        <div className="bg-[#F3F5F7] shadow-md p-2 rounded">
          ...
          <div className="h-6 w-full">
            <h1 className="font-semibold mt-2">Mini Police Car Gallary</h1>
          </div>
        </div>
        ...
        <div className="bg-[#F3F5F7] shadow-md p-2 rounded">
          ...
          <div className="h-6 w-full">
            <h1 className="font-semibold mt-2">Bus Gallary</h1>
          </div>
        </div>
        ...
        {/* <div className="bg-[#F3F5F7] shadow-md p-2 rounded">
          ...
          <div className="h-6 w-full">
            <h1 className="font-semibold mt-2">Mini Train Toys Gallary</h1>
          </div>
        </div>
        ...
        <div className="bg-[#F3F5F7] shadow-md p-2 rounded">
          ...
          <div className="h-6 w-full">
            <h1 className="font-semibold mt-2">Boat Gallary</h1>
          </div>
        </div>
        ...
        <div className="bg-[#F3F5F7] shadow-md p-2 rounded">
          ...
          <div className="h-6 w-full">
            <h1 className="font-semibold mt-2">Bike Gallary</h1>
          </div>
        </div> */}
      </div>
    </section>
